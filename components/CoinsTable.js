...
export default function CoinsTable() {
  ...
  return (<>
    <Box bg="black" w="100%" h="73rem" style={{ fontFamily: "'Inter', sans-serif" }}>
      <Center>
        <VStack spacing="1.5rem">
          <Text color="white" mt="1rem" fontSize="3xl">
            Cryptocurrency Prices by Market Cap
          </Text>
          <Input placeholder='Search Cryptocurrency' size="md" variant="outline"
              ...
              <Table variant='simple'>
                ...
                <Thead bg="#EFBD1D">
                  <Tr>
                    ...
                    <Th fontSize="1rem" color="gray.900">24h Volume</Th>
